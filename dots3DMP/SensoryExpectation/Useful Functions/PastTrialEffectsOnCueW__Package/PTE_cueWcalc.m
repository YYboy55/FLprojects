...
addpath C:\Users\yhaile2\Documents\CODE_Projects\GitHubCodes\Fetschlab\FLprojects\dots3DMP\Fetsch2011_NNcodes % For use of fit_cgauss function
...
[perDeltaXcoh,~,~,~,~,allCohs] = numVOx2(data);
cohs = allCohs(all(perDeltaXcoh>50,2));  % 'cohs' = all the Cohs with >200 trials per delta
% cohs = allCohs;
delta = data.delta;
